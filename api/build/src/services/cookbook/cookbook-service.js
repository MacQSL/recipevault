 ...
 */ export var CookbookService = /*#__PURE__*/ function() {
    "use strict";
    function CookbookService(connection) {
        _class_call_check(this, CookbookService);
        _define_property(this, "repository", void 0);
        _define_property(this, "recipeService", void 0);
        this.repository = new CookbookRepository(connection);
        this.recipeService = new RecipeService(connection);
    }
    _create_class(CookbookService, [
        {
            key: "getUserCookbooks",
            value: function getUserCookbooks(userId) {
                var _this = this;
                return _async_to_generator(function() {
                    return _ts_generator(this, function(_state) {
                        return [
                            2,
                            _this.repository.getCookbooksByUserId(userId)
                        ];
                    });
                })();
            }
