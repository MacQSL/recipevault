 ...
 */ export var RecipeService = /*#__PURE__*/ function() {
    "use strict";
    function RecipeService(connection) {
        _class_call_check(this, RecipeService);
        _define_property(this, "repository", void 0);
        this.repository = new RecipeRepository(connection);
    }
    _create_class(RecipeService, [
        {
            key: "getRecipe",
            value: /**
   * Get recipe.
   ...
   */ function getRecipe(cookbookId) {
                ...
                return _async_to_generator(function() {
                    return _ts_generator(this, function(_state) {
                        ...
                        return [
                            2,
                            _this.repository.getRecipeById(cookbookId)
                        ];
                    });
                })();
            }
   ...
   */ function getCookbookRecipes(cookbookId) {
                ...
                return _async_to_generator(function() {
                    return _ts_generator(this, function(_state) {
                        return [
                            2,
                            _this.repository.getRecipesByCookbookId(cookbookId)
                        ];
                    });
                })();
            }
